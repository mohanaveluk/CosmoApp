...
namespace Cog.WS.Service
{
    public class MailService
    {
        ...
        private readonly Object _currentObject = null;
        ...
        public MailService()
        {
            ...
            _executeData = new WSDataFactory().Create(Convert.ToInt32(iDbType).ToString());
        }
        ...
        private MailMessage GetMailMessage<T>(int envId, string id, T typeObject)
        {
            ...
            try
            {
                ...
                userEmailLst = _executeData.GetUserEMail(envId, id.Contains("sms") ? "T" : "E");
