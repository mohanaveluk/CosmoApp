...
{
    public class EnvironmentUrlConfiguration:TRW.NamedBusinessCode, IFill
    {
        #region properties
        ...
        public List<UrlConfigurationEntity> UrlConfiguration { get; set; }
        ...
        public new void Fill(SqlDataReader reader)
        {
            ...
            UrlConfiguration = new List<UrlConfigurationEntity>();
