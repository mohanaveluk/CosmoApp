...
{
    public class EnvironmentEntity : TRW.NamedBusinessEntity, IFill
    {
        ...
        public List<EnvDetailsEntity> EnvDetailsList { get; set; }

        public string SchedularStatus { get; set; }
        public string SchedularTitle { get; set; }
        ...
        public new void Fill(SqlDataReader reader)
        {
            ...
            EnvDetailsList = new List<EnvDetailsEntity>();
