/****** Object:  StoredProcedure [dbo].[CWT_GetMonitorStatusWithServiceName]    Script Date: 08/09/2015 00:13:38 ******/
SET ANSI_NULLS ON
GO
...
CREATE procedure [dbo].[CWT_GetMonitorStatusWithServiceName] (@ENV_ID int) As
Begin
	select 
		con.ENV_ID,
		con.CONFIG_ID,
