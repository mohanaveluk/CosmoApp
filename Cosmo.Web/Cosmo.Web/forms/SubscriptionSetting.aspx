<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubscriptionSetting.aspx.cs" Inherits="Cosmo.Web.forms.SubscriptionSetting" %>
...
<body>
    <div class="modal-body"  ng-app="dragdrop"  ng-controller="ctrlDualList" id="MainWrap">
        <form id="form1" class="form-horizontal" action="">
            ...
            <div id="modal-process">
                <img id="Img1" src="../images/ajax-loader.gif" alt="Processing..." />
            </div>
